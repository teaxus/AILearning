...
def load_iris_data(CSV_FILE_PATH='./DataSet/Iris.csv'):
...
def main(model_path=None):
    ...
    train_x, test_x, train_y, test_y, Class_dict = load_iris_data(CSV_FILE_PATH)
    ...
    predicted = model.predict(unknown)  # 计算所有选项的预测值
    print("Using model to predict species for features: ")
    print(unknown)
    print("\nPredicted softmax vector is: ")
    # 这个地方会得到一个数组，数组是每一个选项出现的机率，取最大那个机率的索引就是预测值
    print(predicted)
